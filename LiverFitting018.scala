...
object LiverFitting018 {
  ...
  def fitMesh(activeShapeModel : ActiveShapeModel,
    ...
    var generator = MixtureProposal.fromProposalsWithTransition(
      (0.0001, shapeUpdateProposal),   //at 0.6, distance is 277.646, 0.2 279.0666, 0.9 276.7218
      (0.2, rotationUpdateProposal),//initial 0.2
      (0.2, translationUpdateProposal),
      (0.007, shapeUpdateProposal),   //at 0.6, distance is 277.646, 0.2 279.0666, 0.9 276.7218
      (0.2, rotationUpdateProposal),//initial 0.2
      (0.2, translationUpdateProposal)
    )
    ...
    println(COM)
   // val referenceMesh = MeshIO.readMesh(new java.io.File("datasets/validationset/fitting-result/liver-orig013.vtk")).get
    ...
    val discreteTargetImage1 = ImageIO.read3DScalarImageAsType[Float](new java.io.File("datasets/validationset/volume-ct/liver-018.nii")).get.map(_.toFloat)
    ...
    println("Distance is "+ distance)
    val filename=new File("datasets/testset/fitting-result/liver-018.stl")
  ...
  def main(args : Array[String]) : Unit = {
    ...
    val discreteTargetImage = ImageIO.read3DScalarImageAsType[Float](new java.io.File("datasets/validationset/volume-ct/liver-018.nii")).get
