...
object LiverFitting020 {
  ...
  def fitMesh(activeShapeModel : ActiveShapeModel,
    ...
    //val filename=new File("datasets/testset/fitting-result/liver-020.stl")
   // MeshIO.writeMesh(bestFit, filename)
    ...
    val discreteTargetImage1 = ImageIO.read3DScalarImageAsType[Float](new java.io.File("datasets/testset/volume-ct/liver-020.nii")).get.map(_.toFloat)
  ...
  def main(args : Array[String]) : Unit = {
    ...
    val discreteTargetImage = ImageIO.read3DScalarImageAsType[Float](new java.io.File("datasets/validationset/volume-ct/liver-020.nii")).get
